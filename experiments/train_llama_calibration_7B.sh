...
evaluate_lang_directions() {
    ...
    local LANG_DIRECTIONS=("en-de" "en-zh" "de-en" "zh-en") # tower-1 langs
...
# Train mistralai/Mistral-7B-Instruct-v0.1
python -m llama_recipes.calibration --use_peft --peft_method lora \
        --model_name mistralai/$BASE_MODEL \
...
python -m llama_recipes.calibration --use_peft --peft_method lora \
        ...
        --beta $BETA \
        --gama $GAMA \
        --lang_pairs "en-de,de-en,en-zh,zh-en" \
        --listwise_loss \
        --list_size $LIST_SIEZ \
        --use_wandb
!
...
for EPOCH in 0; do
    ...
    python inference_formal.py --model_name mistralai/$BASE_MODEL \
            ...
            --do_sample False \
            --output_dir ${BASE_SYS} \
            --lang_pairs en-zh,en-de,zh-en,de-en \
            --beam_size 5
