...
evaluate_lang_directions() {
    ...
    local LANG_DIRECTIONS=("en-de" "en-fr" "en-nl" "en-it" "en-es" "en-pt" "en-ko" "en-ru" "en-zh") # tower-1 langs
...
# Train
CUDA_LAUNCH_BLOCKING=1 torchrun --nnodes 1 --nproc_per_node 2 --master_port $MASTER_PORT -m llama_recipes.calibration --enable_fsdp --use_peft --peft_method lora \
